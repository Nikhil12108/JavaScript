...
yourArr.unshift(10); // right shift all and add at start (time consuming)

//console.log(myArr)
yourArr.shift(); // shift left and remove first element
//console.log(myArr)

const flag = yourArr.includes(5);
//console.log(flag)

//console.log(myArr.indexOf(3))

const newArray = yourArr.join() // bind and converted to string
...
const myn2 = yourArr.splice(1, 3); // it manipulates your original array
//console.log(myn2)
